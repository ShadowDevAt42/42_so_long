...
/*   Updated: 2025/02/05 17:51:40 by fdi-tria         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_error	init_exit_open(t_game *game)
{
	...
	sprite_path = "srcs/assets/portal/exit_open.xpm";
	error_info.sprite_path = sprite_path;
	error_info.additional_info = NULL;
	game->exit_open.img = mlx_xpm_file_to_image(game->mlx, sprite_path, &width,
			&height);
