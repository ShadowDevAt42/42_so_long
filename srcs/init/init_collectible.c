...
/*   Updated: 2025/02/05 04:53:48 by fdi-tria         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_error init_collectible(t_game *game)
{
    ...
    char        sprite_path[] = "srcs/assets/collectible/diam01.xpm";

    error_info.sprite_path = sprite_path;
    error_info.additional_info = NULL;

    game->collectible.img = mlx_xpm_file_to_image(game->mlx, sprite_path,
            &width, &height);
